...
hover:bg-black p-2 rounded-r opacity-0 group-hover:opacity-100 transition-opacity"
        >
          <svg
            className="w-8 h-8"
            fill="none"
      ...
      >
        {/* Pour chaque film */}
        <div className="shrink-0 w-48">//Affichez la carte</div>
...
hover:bg-black p-2 rounded-l opacity-0 group-hover:opacity-100 transition-opacity"
        >
          <svg
            className="w-8 h-8"
            fill="none"
